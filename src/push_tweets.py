...
HURRICANE_API_URL="https://noreur-dev-data-apim.azure-api.net/noreur-dev-dataeng-FA3/HttpTriggerTweetsToBlobAndEventHub3"
AUTH_VALUE="Basic UGE1NXcucmQxMjM0OlBhNTV3LnJkMTIzNA=="
OCP_APIM_SUBSCRIPTION_VALUE = "6ae179c27d9740c2b2be7b91839835a6"

# URL = f"{HURRICANE_API_URL}"
# URL = "http://localhost:7071/api/HttpTrigger1"
URL=HURRICANE_API_URL
headers = {
